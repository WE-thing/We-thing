...
export default function WeddingGift() {
  return (
    <div className="w-full h-[300px] p-4 box-border bg-theme1-primary">
      <div className=" text-heading3 text-theme1-black font-nanum font-bold flex items-center justify-center">
        신랑&신부에게 마음전하기
      </div>
      ...
      <div className="flex justify-around w-[300px] my-[50px] mx-auto">
        <div>
          ...
          <button className="mt-6 px-8 py-2 rounded-full bg-gray text-white font-nanum ">
            계좌번호
          </button>
        </div>
        <div>
